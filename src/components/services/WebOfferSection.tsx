...
const OfferCard = ({
  ...
  const bgGradient = isGold
    ? "radial-gradient(ellipse at top right, rgba(195,182,143,0.08) 0%, transparent 50%)"
    : "radial-gradient(ellipse at top right, rgba(124,106,232,0.08) 0%, transparent 50%)";
  ...
  return (
    ...
    >
      ...
      <div
        className="relative flex flex-col items-center text-center p-8 md:p-10 rounded-3xl border-2 bg-white transition-all duration-500 h-full overflow-hidden"
        style={{
          borderColor,
      ...
      >
        ...
        <motion.p
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.55 + index * 0.2 }}
        ...
        {/* Benefits list */}
        <motion.ul
          className="space-y-3 mb-10 text-left w-full flex-grow"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={{
            visible: {
              transition: { staggerChildren: 0.08, delayChildren: 0.7 + index * 0.2 },
            },
          }}
        >
          {benefits.map((benefit, benefitIndex) => (
            ...
            >
              ...
              <span
                ...
                style={{ color: "#2D284D", opacity: 0.85 }}
              >
        ...
        >
          <Button
            asChild
            size="lg"
            className="w-full rounded-xl px-8 py-6 text-base font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg"
            style={{
      ...
      <div className="container max-w-6xl mx-auto px-4">
        ...
        >
          <motion.div
            ...
            style={{ background: "rgba(45,40,77,0.05)" }}
          >
            <span className="text-sm font-medium" style={{ color: "#2D284D" }}>
              💎 Offres sur mesure
            </span>
          </motion.div>
          ...
          >
            ...
            une même <strong style={{ color: "#C3B68F" }}>exigence de qualité</strong>.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10">
          <OfferCard
            ...
            variant="gold"
            icon={<Monitor className="w-8 h-8 text-[#2D284D]" />}
            index={0}
          />
          <OfferCard
            title="Landing page"
            ...
            variant="purple"
            icon={<Rocket className="w-8 h-8 text-[#2D284D]" />}
            index={1}
          />
        </div>
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(90deg, transparent, #C3B68F)" }}
          />
          <div
            className="w-2 h-2 rounded-full"
            style={{ background: "linear-gradient(135deg, #C3B68F, #7C6AE8)" }}
          />
          <div
            className="h-px flex-1 max-w-[100px]"
            style={{ background: "linear-gradient(90deg, #7C6AE8, transparent)" }}
          />
        </motion.div>
      </div>
    </section>

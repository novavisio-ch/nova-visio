  ...
  return <section className="py-20 md:py-28 bg-gray-50">
      <div className="container max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-body-lg text-gray-600 max-w-2xl mx-auto">Une identité visuelle professionnelle simplifie votre quotidien et renforce la perception de votre marque. ​<br className="hidden md:block" />
            ​
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {benefits.map((benefit, index) => <div key={index} className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">

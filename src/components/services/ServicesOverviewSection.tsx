    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-gray-50 via-white to-gray-50 overflow-hidden relative">
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <motion.div
            className="lg:col-span-2 rounded-2xl md:rounded-3xl overflow-hidden"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 p-6 md:p-8 h-full flex flex-col justify-between">
                ...
                <a 
                  href="/contact" 
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full font-semibold text-sm text-gray-900 transition-all duration-300 hover:gap-3 hover:shadow-lg hover:shadow-[#C3B68F]/25 w-full"
                  style={{

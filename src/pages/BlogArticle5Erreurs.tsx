          ...
          <article className="max-w-4xl article-card p-6 md:p-10 lg:p-12">
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-lg text-muted-foreground">Définissez un objectif principal : prise de rendez-vous, demande de devis, demande d'appel découverte, inscription à une newsletter, etc.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Identifiez 1 ou 2 objectifs secondaires (par exemple téléchargement d'un PDF, consultation d'un portfolio, inscription à un webinar).</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Vérifiez que chaque page importante oriente vers cet objectif : CTA visibles, texte qui pousse naturellement vers la prise de contact ou l'étape suivante.</span>
                </li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Travaillez un message d'accroche clair (titre + sous-titre) qui répond à : "Qui êtes-vous ? Pour qui ? Et quel résultat principal apportez-vous ?"</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Structurez la page d'accueil en blocs lisibles : présentation de votre valeur (bénéfices pour le client), services principaux, preuves (avis, logos clients, avant/après), processus de collaboration, appel à l'action.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Limitez le nombre d'éléments dans le menu et évitez les sections qui n'apportent rien à l'objectif principal.</span>
                </li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Pensez "mobile first" : est-ce que les textes se lisent facilement sur un petit écran, est-ce que les boutons sont cliquables sans zoomer, est-ce que les sections s'enchaînent de manière fluide.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Optimisez les images et vidéos : formats adaptés, compression, pas d'images en très haute définition pour un simple visuel de fond.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Testez votre site sur de vrais appareils (pas seulement dans un simulateur) : prenez votre téléphone, celui d'un proche, et essayez de faire une action complète, par exemple envoyer un message via le formulaire.</span>
                </li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Reformulez vos textes en partant des problèmes de vos clients : manque de visibilité, site obsolète, image de marque peu cohérente, etc.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Mettez en avant les résultats concrets : plus de demandes, meilleure clarté de l'offre, meilleure perception de la marque.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Utilisez un langage simple, sans jargon technique inutile, et ajoutez des cas clients, des avis et une FAQ qui répond aux questions que vous entendez en rendez-vous.</span>
                </li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Ajoutez un appel à l'action clair et récurrent : "Parler de votre projet", "Demander un devis", "Réserver un appel de 20 minutes".</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Simplifiez votre formulaire de contact : commencez avec les champs essentiels (nom, email, type de projet, message) et posez les questions détaillées plus tard, une fois le contact établi.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-lg text-muted-foreground">Rassurez en expliquant ce qui se passe après l'envoi : délai de réponse, format de l'échange (email, visio, téléphone), absence d'engagement immédiat.</span>
                </li>
              </ul>

...
const IdentiteVisuelle = () => {
  return (
    <Layout>
      ...
      {/* Maintenance Block */}
      <MaintenanceBlock
        text="Votre identité est livrée - maintenant il faut la déployer partout sans se perdre. Notre suivi mensuel à 89 CHF/mois veille sur votre présence en ligne pendant que vous vous concentrez sur votre métier."
      />

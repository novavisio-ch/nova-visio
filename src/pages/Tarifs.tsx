...
const ServiceCard = ({ 
  ...
  const hoverVariants = isMobile ? {} : {
    ...
    boxShadow: isGold 
      ...
      : "0 20px 60px -15px rgba(124, 106, 232, 0.4), 0 0 40px rgba(124, 106, 232, 0.15)",
  };

  const inViewVariants = isMobile ? {
    boxShadow: isGold 
      ? "0 15px 40px -10px rgba(195, 182, 143, 0.3)"
      : "0 15px 40px -10px rgba(124, 106, 232, 0.3)",
  } : {};
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: isGold 
            ...
            : "linear-gradient(135deg, #9D8DF0 0%, transparent 50%, #9D8DF0 100%)",
      ...
      <div 
        className="relative h-full rounded-2xl border p-6 md:p-8 transition-all duration-500 overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="flex items-start gap-4 mb-5">
          ...
          >
            <Icon 
              className="w-8 h-8 md:w-10 md:h-10 transition-colors duration-300 group-hover:drop-shadow-[0_0_12px_rgba(195,182,143,0.5)]" 
        ...
        >
          ...
          <span 
            ...
            style={{
              background: isGold 
                ...
                : "linear-gradient(135deg, #9D8DF0 0%, #B8A9F5 50%, #7C6AE8 100%)",
          ...
          <motion.div
            ...
            style={{ background: isGold ? "#C3B68F" : "#9D8DF0" }}
            initial={{ width: 0 }}
...
const ComplementaryCard = ({ 
  ...
  return (
    <motion.div
      ...
      className="group rounded-xl border border-[#C3B68F]/20 p-5 md:p-6 transition-all duration-300 hover:border-[#C3B68F]/50 relative overflow-hidden"
      style={{
    ...
    <Layout>
      ...
      >
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          ...
          {/* Main Services Grid */}
          <div 
            className="grid md:grid-cols-3 gap-6 md:gap-8 mb-20 md:mb-28"
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="text-center rounded-2xl p-8 md:p-12 relative overflow-hidden"
            style={{
